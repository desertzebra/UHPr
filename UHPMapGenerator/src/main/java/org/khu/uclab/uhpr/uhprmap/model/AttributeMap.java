...
public class AttributeMap {
    private Attribute nodeLeft;
    private Attribute nodeRight;
    ...
    public AttributeMap(Attribute nodeLeft, Attribute nodeRight, SchemaRelation relationship,String method, double confidence) {
    ...
    public Attribute getNodeLeft() {
        return nodeLeft;
    }

    public void setNodeLeft(Attribute nodeLeft) {
        this.nodeLeft = nodeLeft;
    }

    public Attribute getNodeRight() {
        return nodeRight;
    }

    public void setNodeRight(Attribute nodeRight) {
        this.nodeRight = nodeRight;
    }
