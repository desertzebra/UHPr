...
public class Openemr_Demographics extends MedicalFragment {
    ...
    public void setRandomFields() {
    	...
    	ExternalID = "";
    	DOB = "";	// will be set by setPrivate();
    	Sex = "";	// will be set by setPrivate();
    	SS = stringGen.getRandomNumbers(10);
    	License = "";
    	MaritalStatus = stringGen.getRandomMaritalStatus();
    	UserDefined = "";
    	BillingNote = "";
    	// Address
    	Address = regionGen.getRandomAddress();
    	City = regionGen.getRandomCity();
    	State = regionGen.getRandomState();
    	PostalCode = stringGen.getRandomNumbers(5);
    	Country = regionGen.getRandomCountry();
    	MotherName = nameGen.getRandomName(1);
    	EmergencyContact = stringGen.getRandomPhoneNumberKR();
    	EmergencyPhone = stringGen.getRandomPhoneNumberKR();
    	HomePhone = stringGen.getRandomPhoneNumberKR();
    	WorkPhone = stringGen.getRandomPhoneNumberKR();
    	MobilePhone = stringGen.getRandomPhoneNumberKR();
    	ContactEmail = stringGen.getRandomEmail();
    	TrustedEmail = stringGen.getRandomEmail();
    	// Choices
    	Provider = nameGen.getRandomName(genderGen.getRandomGender());
    	Referring_Provider = "";
    	Pharmacy = stringGen.getRandomWord() + " pharmacy";
    	HIPPANoticeReceived = stringGen.getRandomSign();
    	AllowVoiceMessage = stringGen.getRandomSign();
    	LeaveMessageWith = "";
    	AllowMailMessage = stringGen.getRandomSign();
    	AllowSMS = stringGen.getRandomSign();
    	AllowEmail = stringGen.getRandomSign();
    	AllowImmunizationRegistryUse = stringGen.getRandomSign();
    	AllowImmunizationInfoSharing = stringGen.getRandomSign();
    	AllowHeartInformationExchange = stringGen.getRandomSign();
    	AllowPatientPortal = stringGen.getRandomSign();
    	CareTeam = stringGen.getRandomWord() + " team";
    	CMSPortalLogin = stringGen.getRandomSign();
    	ImmunizationRegistryStatus = stringGen.getRandomSign();
    	ImmunizationRegistryStatusEffectiveDate = dateGen.getRandomDateInYear(2020);
    	PublicityCode = stringGen.getRandomNumbers(10);
    	PublicityCodeEffectiveDate = dateGen.getRandomDateInYear(2020);
    	ProtectionIndicator = stringGen.getRandomNumbers(10);
    	ProtectionIndicatorEffectiveDate = dateGen.getRandomDateInYear(2020);
    	// Status
    	Language = stringGen.getRandomLanguage();
    	Race = stringGen.getRandomRace();
    	Ethnicity = "";
    	FamilySize = stringGen.getRandomNumber();
    	FinancialReviewDate = dateGen.getRandomDateInYear(2018);
    	Homeless = "no";
    	MonthlyIncome = String.valueOf(rand.randInt(1, 1000)) + "000";
    	Interpreter = "";
    	MigrantSeasonal = "";
    	VFC = "";
    	Religion = "";
    ...
    public void setPrivate(String firstName, String lastName, String dob, int gender) {
    	...
    	Sex = genderGen.getGenderString(gender, "male", "female");
    	DOB = dob;
    }
